...
3. 您可以在协议规定的约束和限制范围内为互动维客提供相关的插件，插件版权归作者所有。您可以将拥有版权的插件无偿提供给互动在线（北京）科技有限公司，但没有一定被采纳的承诺或保证。如若在新版本里采用了您开发的插件，插件源代码部分将标注作者的名字。

4. 您若需要本协议授权外的技术支持，可以和互动在线（北京）科技有限公司签订有偿技术支持的协议，并且享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。 自协议签订时刻起，您可以在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。

5. 您若是没有和互动在线（北京）科技有限公司签订有偿技术支持协议的授权用户，您也同样享有反映和提出意见的权力，但没有一定被采纳的承诺或保证。

II. 协议规定的约束和限制

1. 不得对本软件或与之关联的授权进行出租、出售、抵押或发放子许可证。

2. 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用互动维客的整体或任何部分，未经书面许可，系统页面页脚处的互动维客名称和互动在线（北京）科技有限公司下属网站（http://www.hudong.com） 的链接都必须保留，而不能清除或修改。
...
3. 互动在线（北京）科技有限公司不对使用本软件构建的系统中的文章或信息承担任何责任。
...
$lang['step2PHPVersionTooLowTip'] = '您的PHP版本低于4.1.0, 无法使用HDWiki';
...
$lang['stepSetupDelInstallDirTip'] = '<div class="log">提示信息</div><div class="mes"><p>请尽快删除整个 install 目录或把install.php改名，以免被他人恶意利用。</p></div>';
